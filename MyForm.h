...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->f4FovTrackbar->Margin = System::Windows::Forms::Padding(4);
			...
			this->pictureAboutIcon->Margin = System::Windows::Forms::Padding(4);
			...
			this->pictureYouTubeIcon->Margin = System::Windows::Forms::Padding(4);
			...
			this->pictureGitHubIcon->Margin = System::Windows::Forms::Padding(4);
			...
			this->labelAboutAuthor->TabIndex = 7;
			...
			this->f4FovToggle->Margin = System::Windows::Forms::Padding(4);
			...
			this->f4FovNumericUpDown->Margin = System::Windows::Forms::Padding(4);
			...
			this->pinToTopToggle->Margin = System::Windows::Forms::Padding(4);
